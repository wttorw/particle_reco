...
int main( int argc, char* argv[] ) {
  ...
  int_file << endl;
  int_file << "  // constructor" << endl;
  int_file << "  " << name << "();" << endl;
  int_file << "  // deleted copy constructor and assignment to prevent unadvertent copy" << endl;
  int_file << "  " << name
           << "           ( const " << name << "& x ) = delete;" << endl;
  int_file << "  " << name
           << "& operator=( const " << name << "& x ) = delete;" << endl;
  int_file << endl;
  int_file << "  // destructor" << endl;
  int_file << "  virtual ~"
           <<         name << "();" << endl;
